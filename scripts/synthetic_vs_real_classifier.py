...
def main(argv):
    ...
    train_dataset = SyntheticVRealDataset(dataset_images[0:-500], fake_images[0:-500], tag='train')
    test_dataset = SyntheticVRealDataset(dataset_images[-500:-1], fake_images[-500:-1], tag='test')
