...
def main(argv):
    ...
    parser.add_argument(
        "--output_directory",
        default="../render_scene/livingroom/",
    ...
    parser.add_argument(
        "--path_to_floor_path",
        default='../dump/Bedroom_Folders/7d8f9ace-5704-4689-b135-4ece5fb32467_SecondBedroom-45070',
    ...
    parser.add_argument(
        "--weight_file",
        default='../savepoint/livingroom_ebvae_h32_mss',
    ...
    parser.add_argument(
        "--tag",
        default="livingroom_ebvae_h32_mss",
        help="number of sequences"
    )
    ...
    processor = Processor(
        ...
        config_path='../config/livingroom_config.yaml',
        generator_type=args.generator_type,
        discriminator_type=args.discriminator_type,
        version='checkpoint_eval800.tar',
        device=device
    )
